                                ...
                                <div className="p-5">
                                    <div className="flex flex-col items-center mb-8">
                                        ...
                                        <div className="flex gap-3 mt-6 w-full max-w-sm">
                                            <a href={selectedproject.link || '#'} target="_blank" rel="noopener noreferrer" className="flex-1 py-3 bg-accent text-white rounded-xl font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity text-[15px]">
                                                <IoOpenOutline size={18} />
                                                View
                                            </a>
                                            <a href={selectedproject.github || '#'} target="_blank" rel="noopener noreferrer" className="flex-1 py-3 bg-[#F2F2F7] dark:bg-white/10 text-accent rounded-xl font-semibold flex items-center justify-center gap-2 hover:bg-[#e5e5ea] dark:hover:bg-white/20 transition-colors text-[15px]">
                    ...
                    {selectedproject ? (
                        ...
                        >
                            <div className="flex items-center px-4 h-[50px] border-b border-black/5 dark:border-white/5 bg-white dark:bg-[#1c1c1e] pl-20 shrink-0">
                                <button
                                    onClick={() => setselectedproject(null)}
                                    className={`flex items-center gap-1 text-accent font-medium hover:opacity-70 transition-opacity text-[14px]`}
                                >
                                    ...
                                    <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                                        ...
                                        <div className="flex-1 text-center md:text-left">
                                            ...
                                            <div className="flex flex-wrap justify-center md:justify-start gap-2">
                                                <a href={selectedproject.link || '#'} target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-accent text-white rounded-full font-semibold flex items-center gap-2 hover:opacity-90 transition-opacity text-sm">
                                                    <IoOpenOutline size={16} />
                                                    View Project
                                                </a>
                                                <a href={selectedproject.github || '#'} target="_blank" rel="noopener noreferrer" className="px-4 py-1.5 bg-[#F2F2F7] dark:bg-white/10 text-accent rounded-full font-semibold flex items-center gap-2 hover:bg-[#e5e5ea] dark:hover:bg-white/20 transition-colors text-sm">
                        ...
                        >
                            ...
                            <div className="p-6 md:p-10 pt-6 max-w-7xl mx-auto w-full">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <span className="text-accent text-sm font-semibold">{filteredprojects.length} items</span>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {filteredprojects.map((proj) => (
                                        ...
                                        >
                                            ...
                                            <button className="w-full py-2 bg-accent/10 text-accent rounded-xl text-[13px] font-semibold group-hover:bg-accent group-hover:text-white transition-all flex items-center justify-center gap-2">
                                                <IoOpenOutline size={16} />
                                                View Details
                                            </button>
                                        </div>
