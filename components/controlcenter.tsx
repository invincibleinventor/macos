    ...
    <AnimatePresence>
      {isopen && (
        <motion.div
          ...
          className={`${ismobile
            ? `fixed inset-0 w-full h-full rounded-none flex items-center justify-center pt-10 ${reducetransparency ? 'bg-neutral-100 dark:bg-neutral-900' : 'backdrop-blur-sm bg-white/40 dark:bg-black/40'}`
