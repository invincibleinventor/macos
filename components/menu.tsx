        ...
        >
            ...
            {props.visible && (
                <motion.div
                    ...
                    className="absolute left-0 sm:left-auto mt-4 min-w-56 w-max bg-white/20 dark:bg-neutral-900/20 rounded-xl flex flex-col space-y-[1px] p-[6px]  border-[0.01px] border-neutral-600 dark:border-neutral-500 z-[10]"
                >
